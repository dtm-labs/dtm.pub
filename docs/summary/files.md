...
http协议在[dtm-examples](https://github.com/dtm-labs/dtm-examples)里面定义TransIn、TransOut相关的各个基本操作，如下：
...
grpc协议在[dtm-examples](https://github.com/dtm-labs/dtm-examples)里面定义TransIn、TransOut相关的各个基本操作，如下：
